...
public:
    ...
    // One input trait
    template <class T1>
    void registerBehavior(void (*func) (const Entity&, const T1&, T1&))
    {
    ...
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, T1&))
    {
    ...
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, T1&))
    {
    ...
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, T1&))
    {
    ...
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, const T5&, T1&))
    {
    ...
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, const T5&, const T6&, T1&))
    {
    ...
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, const T5&, const T6&, const T7&, T1&))
    {
    ...
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, const T5&, const T6&, const T7&, const T8&, T1&))
    {
    ...
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, const T5&, const T6&, const T7&, const T8&, const T9&, T1&))
    {
    ...
    // One input trait
    template <class T1>
    void registerBehavior(void (*func) (const Entity&, const T1&))
    {
    ...
    // Two input traits
    template <class T1, class T2>
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&))
    {
    ...
    // Three input traits
    template <class T1, class T2, class T3>
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&))
    {
    ...
    // Fourinput traits
    template <class T1, class T2, class T3, class T4>
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&))
    {
    ...
    // Five input traits
    template <class T1, class T2, class T3, class T4, class T5>
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, const T5&))
    {
    ...
    // Six input traits
    template <class T1, class T2, class T3, class T4, class T5, class T6>
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, const T5&, const T6&))
    {
    ...
    // Seven input traits
    template <class T1, class T2, class T3, class T4, class T5, class T6, class T7>
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, const T5&, const T6&, const T7&))
    {
    ...
    // Eight input traits
    template <class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8>
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, const T5&, const T6&, const T7&, const T8&))
    {
    ...
    // Nine input traits
    template <class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9>
    void registerBehavior(void (*func) (const Entity&, const T1&, const T2&, const T3&, const T4&, const T5&, const T6&, const T7&, const T8&, const T9&))
    {
